          ...
          {companyInfo.values.map((value, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-xl border border-border/40 bg-card p-6 text-center"
              >
                <div className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand/10">
